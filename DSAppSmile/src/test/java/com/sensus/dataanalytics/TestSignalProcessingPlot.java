...
public class TestSignalProcessingPlot extends PlotPanel {

    @Test
    public void runTestSignalProcessing()
    {
        ...
        File file = new File("/home/vagrant/tmp/signal.png");
        try {
            Thread.sleep(4000);
    ...
    public TestSignalProcessingPlot() {
